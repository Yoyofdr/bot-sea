...
CRON_CMD="0 8 * * * cd $PROJECT_DIR && $(which python3) -m seia_monitor run --once >> $PROJECT_DIR/logs/cron.log 2>&1"
...
echo "✅ Cron job configurado para ejecutarse diariamente a las 08:00 AM"
echo ""
...
echo ""
echo "📁 Directorio: $PROJECT_DIR"
echo "🕐 Cron: Todos los días a las 08:00 AM"
echo ""
echo "📝 PRÓXIMOS PASOS:"
echo ""
